...
The user can choose their ideal AI model from the WebLLM catalog and press DOWNLOAD to begin using it, or you can directly use the app with the default: Llama-3.2-1B-Instruct-q4f32_1-MLC model.
